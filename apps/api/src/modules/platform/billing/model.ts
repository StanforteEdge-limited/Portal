...
export const modules_platform_billingRelations = defineRelationsPart({ subscriptionPlan, subscriptionPlanPrice, tenantSubscription, billingInvoice, billingPaymentAttempt, billingWebhookEvent });
