...
import { CreateTransferDto } from '$modules/finance/finance/dto/create-transfer.dto';
import { UpsertFinanceAssetDto } from '$modules/finance/finance/dto/upsert-finance-asset.dto';
import { CreateFinanceAssetVerificationDto } from '$modules/finance/finance/dto/create-finance-asset-verification.dto';
import { CreateFinanceAssetDisposalDto } from '$modules/finance/finance/dto/create-finance-asset-disposal.dto';
import { UpsertFinanceChartAccountDto } from '$modules/finance/finance/dto/upsert-finance-chart-account.dto';
import { UpsertFinanceReportingPeriodDto } from '$modules/finance/finance/dto/upsert-finance-reporting-period.dto';
import { UpsertFinanceCustomerDto } from '$modules/finance/finance/dto/upsert-finance-customer.dto';
import { UpsertFinanceVendorDto } from '$modules/finance/finance/dto/upsert-finance-vendor.dto';
import { UpsertContactDto } from '$modules/finance/finance/dto/upsert-contact.dto';
import { CreateFinanceSalesInvoiceDto } from '$modules/finance/finance/dto/create-finance-sales-invoice.dto';
import { CreateFinanceBillDto } from '$modules/finance/finance/dto/create-finance-bill.dto';
import { CreateFinanceReceiptDto } from '$modules/finance/finance/dto/create-finance-receipt.dto';
import { CreateFinanceVendorPaymentDto } from '$modules/finance/finance/dto/create-finance-vendor-payment.dto';
import { UpsertFinanceReportNoteDto } from '$modules/finance/finance/dto/upsert-finance-report-note.dto';
import { UpsertFinanceDonorDto } from '$modules/finance/finance/dto/upsert-finance-donor.dto';
import { UpsertFinanceFundDto } from '$modules/finance/finance/dto/upsert-finance-fund.dto';
import { UpsertFinanceGrantDto } from '$modules/finance/finance/dto/upsert-finance-grant.dto';
import { UpsertFinancePledgeDto } from '$modules/finance/finance/dto/upsert-finance-pledge.dto';
import { UpsertFinanceBudgetDto } from '$modules/finance/finance/dto/upsert-finance-budget.dto';
import { CopyFinanceBudgetDto } from '$modules/finance/finance/dto/copy-finance-budget.dto';
import { SubmitFinanceBudgetRevisionDto } from '$modules/finance/finance/dto/submit-finance-budget-revision.dto';
import { ActionFinanceBudgetRevisionDto } from '$modules/finance/finance/dto/action-finance-budget-revision.dto';
import { UpdatePaymentVoucherDto } from '$modules/finance/finance/dto/update-payment-voucher.dto';
...
import { CreateManualJournalEntryDto } from '$modules/finance/finance/dto/create-manual-journal-entry.dto';
import { CreateStatutoryDeductionManualEntryDto } from '$modules/finance/finance/dto/create-statutory-deduction-manual-entry.dto';
...
import { UpdateJournalEntryDto } from '$modules/finance/finance/dto/update-journal-entry.dto';
import { AddRemittanceAllocationsDto, UpdatePendingDeductionDto, UpdateRemittanceRecordDto } from '$modules/finance/finance/dto/update-deduction.dto';
