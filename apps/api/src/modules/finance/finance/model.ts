...
export const modules_finance_financeRelations = defineRelationsPart({ financeSetting, financeAccount, financeDonor, financeFund, financeGrant, financePledge, financeChartAccount, financeReportingPeriod, financeJournalEntry, financeJournalSequence, financeJournalLine, financeLedgerEntry, financeIncomeEntry, financeAsset, financeAssetVerification, financeAssetDisposal, financeContact, financeContactPerson, financeSalesInvoice, financeSalesInvoiceLine, financeReceipt, financeReceiptAllocation, financeBillHeader, financeBillLine, financeVendorPayment, financeReportNote, financeBudget, financeBudgetLine, financeBudgetAssumption, financeBudgetPortfolio, financeBudgetRevision, financeBudgetRevisionLine, financeBudgetCommitment, financePaymentVoucher, financePaymentVoucherItem, financePaymentVoucherFile, financePaymentVoucherCorrection, financeItem, financeExpense, financeDeductionType, financePVDeduction, financeRequestDeduction, financeRequestRemittance, financeRequestDeductionRemittanceAllocation, financeVendorWHTAccrual, financeWHTRemittance });
