...
export const modules_hr_hrRelations = defineRelationsPart({ employeeProfile, employeeMeta, attendanceEntry, attendanceDaily, attendanceHoliday, attendanceCorrection, attendanceException, leaveBalanceLedger, onboardingProgress, hrDesignation });
